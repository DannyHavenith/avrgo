...
TEST_F( CoreTest, st_x_inc)
{
    ...
    EXPECT_EQ( 0, core.reg(26));
    EXPECT_EQ( 2, core.reg(27));
...
TEST_F( CoreTest, LPM_Z_inc)
{
    ...
    EXPECT_EQ( 0, core.reg(30));
    EXPECT_EQ( 2, core.reg(31));
    EXPECT_EQ( 0x42, core.reg(0));
    EXPECT_EQ( flags_t{}, core.flags);
}
...
TEST_F( CoreTest, LPM_Z)
{
    ...
    EXPECT_EQ( 255, core.reg(30));
    EXPECT_EQ( 0x42, core.reg(31));
    EXPECT_EQ( flags_t{}, core.flags);
...
{
    core.assign8( 28, 0x04);
    core.assign8( 29, 0x01);

    Execute("00:    22 97           sbiw    r28, 0x02");

    EXPECT_EQ( 0x02, core.reg(28));
    EXPECT_EQ( 0x01, core.reg(29));
...
{
    core.assign8( 28, 0x01);
    core.assign8( 29, 0x01);

    Execute("00:    22 97           sbiw    r28, 0x02");


    EXPECT_EQ( 0x00, core.reg(27));
    EXPECT_EQ( 0xff, core.reg(28));
    EXPECT_EQ( 0x00, core.reg(29));
    EXPECT_EQ( 0x00, core.reg(30));
...
TEST_F( CoreTest, CPR_halfcary)
{
    ...
    core.assign8( 27, 0x20);
    core.assign8( 17, 0x1F);
    core.flags = flags_t{};
